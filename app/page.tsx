  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between py-24 px-2 lg:px-24 ">
      <div className="w-full h-full max-w-xl space-y-2">
        <h1 className="w-full text-center font-bold mb-4 lg:text-lg xl:text-3xl text-base">
          make slugify easier
        </h1>
      ...
      <div className="space-y-2">
        <Link
          className="flex items-center space-x-2 font-semibold text-gray-900  underline-offset-4 dark:text-white hover:text-orange-500"
          href={"https://github.com/KazooTTT/auto-slugify-webapp"}
          target="_blank"
        >
          <div>source code</div>
          <svg
        ...
        <div>
          ...
          <Link
            ...
            target="_blank"
            className="ml-2 font-semibold text-gray-900 underline underline-offset-4 dark:text-white decoration-sky-500 decoration-wavy hover:text-orange-500"
          >
            kazoottt
          </Link>
        </div>
